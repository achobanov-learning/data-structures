namespace _01.RedBlackTree
{
    ...
    public class BinarySearchTree<T> : IBinarySearchTree<T> where T : IComparable
    {
        ...
        {
            this._root = this.Insert(element, this._root);
        }
        ...
        public IEnumerable<T> Range(T startRange, T endRange)
        {
            ...
            this.Range(this._root, queue, startRange, endRange);
        ...
        public void Delete(T element)
        {
            ...
            this._root = this.Delete(element, this._root);
        }
        ...
        {
            return this.Rank(element, this._root);
        }

        public T Select(int rank)
        {
            Node node = this.Select(rank, this._root);
            if (node == null)
            {
                throw new InvalidOperationException();
            }
